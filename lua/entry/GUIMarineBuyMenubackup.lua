...
GUIMarineBuyMenu.kExtraButtonsTexture             = PrecacheAsset("ui/buymenu_marine/buttons_for_new_weapons.dds")
...
GUIMarineBuyMenu.kExtraArmoryBigPicturesTexture   = PrecacheAsset("ui/buymenu_marine/armory_bigicons_new_weapons.dds")
...
kTechIdInfo[kTechId.Cannon] =   { 	ButtonTextureIndex = 0,
									BigPictureIndex = 0,
									Description = "A weapon suited to popping low armoured lifeforms",
									Stats = {   LifeFormDamage = 1,         
												StructureDamage = 0.6,
												Range = 1,
											}
}
...
function GUIMarineBuyMenu:_CreateButton(parent, buttonPosition, buttonTechId)
	...
	if buttonTechId == kTechId.Cannon then
		buyButton:SetTexture(self.kExtraButtonsTexture)
	else
