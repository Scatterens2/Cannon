...
local kAttackSoundName = PrecacheAsset("sound/Cannon.fev/combat_cannon/canon_fire")
local kLocalAttackSoundName = PrecacheAsset("sound/Cannon.fev/combat_cannon/fire_client")
